 ...
 * The student data use a DoubleLinkList use the simplest bubble sort.
 * The DoubleLinkList is not circular, and the next of the last node points to the NULL and does not point to the first node, except that it is the same as the DoubleCircularLinkList,
 */
